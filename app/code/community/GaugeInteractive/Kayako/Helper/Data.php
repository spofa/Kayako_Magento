...
class GaugeInteractive_Kayako_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    const XML_PATH_CONTACTS_KAYAKO_ISSUES       = 'contacts/kayako/issues';
     ...
     * @return string
     */
    public function getKayakoIssues()
    {
        return Mage::getStoreConfig(self::XML_PATH_CONTACTS_KAYAKO_ISSUES);
    }
